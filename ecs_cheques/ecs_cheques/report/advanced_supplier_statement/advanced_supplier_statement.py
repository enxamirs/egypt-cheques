...
"""
Advanced Supplier Statement – Script Report

Produces a professional, multi-currency supplier ledger statement directly
from GL Entry records.  The report supports:

  * Company-mandatory filter with date range
  * Multi-select Account and Supplier filters
